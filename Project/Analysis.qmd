...
# Get all unique target names (excluding the source)
target_names <- nodes$name[nodes$name != "Oceanus Folk"]

colour_scale <- JS(paste0(
  'd3.scaleOrdinal()
     .domain(["Oceanus Folk", "', paste(target_names, collapse = '", "'), '"])
     .range(["#2E3192"].concat(d3.schemeCategory10))'
))
