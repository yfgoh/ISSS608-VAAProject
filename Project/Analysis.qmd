...
<<Calvin, need your help. The total music should be 305 for OF, similar to first table, but i cant seem to get the number despite using total_music = n_distinct(song_to). Can help to update it? This table dont need % as the logic is how many genre influence OF.>>> 
