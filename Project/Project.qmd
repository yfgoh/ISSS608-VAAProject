...
# {style="color:DarkOrange"} 1 Overview
...
## {style="color:DarkOrange"} 1.1 Background
...
## {style="color:DarkOrange"} 1.2 Tasks and Questions
...
## {style="color:DarkOrange"} 1.5 Install and Load the Required Libraries
...
## {style="color:DarkOrange"} 1.6 Importing Data
...
# {style="color:DarkOrange"} 2 Data Pre-Processing

## {style="color:DarkOrange"} 2.1 Split into Nodes and Edges
...
### {style="color:DarkOrange"} 2.1.1 Get Nodes
...
### {style="color:DarkOrange"} 2.1.2 Get Edges
...
## {style="color:DarkOrange"} 2.2 Data Overview
...
## {style="color:DarkOrange"} 2.3 Adding Identifying Columns
...
## {style="color:DarkOrange"} 2.4 Convert Date Fields
...
## {style="color:DarkOrange"} 2.5 Check and Fix Duplicates

### {style="color:DarkOrange"} 2.5.1 Duplicates in Nodes
...
### {style="color:DarkOrange"} 2.5.2 Duplicates in Edges
...
## {style="color:DarkOrange"} 2.6 Check Nodes and Edges range
...
## {style="color:DarkOrange"} 2.7 Mapping Node name to Edges id
...
### {style="color:DarkOrange"} 2.7.1 Create Edge Mapping from original id to kept id
...
## {style="color:DarkOrange"} 2.8 Remove unmatched (invalid) edges
...
## {style="color:DarkOrange"} 2.9 Check for any missing nodes
...
## {style="color:DarkOrange"} 2.10 Checking Edges Schema
...
## {style="color:DarkOrange"} 2.11 Temporal Validation
...
## {style="color:DarkOrange"} 2.12 Check for orphan nodes
...
## {style="color:DarkOrange"} 2.13 Creating Consistent Visualisation Colouring
...
## {style="color:DarkOrange"} 2.14 Creating the Global Knowledge Graph
...
# {style="color:DarkOrange"} 3 Exploratory Data Analysis (EDA) on Sailor Shift's career
...
## {style="color:DarkOrange"} 3.1 Visualising Sailor Shift's Music
...
## {style="color:DarkOrange"} 4.2 Question 1a) Who has she been most influenced by over time?
...
## {style="color:DarkOrange"} 4.3 Question 1b) Who has she collaborated with and directly or indirectly influenced?
...
## {style="color:DarkOrange"} 4.4 Question 1c) How has she influenced collaborators of the broader Oceanus Folk community?
...
# {style="color:DarkOrange"} 5 VAST 2025 MC1 Question 2
...
## {style="color:DarkOrange"} 5.1 Question 2a) Was this influence intermittent or did it have a gradual rise?
...
## {style="color:DarkOrange"} 5.2 Question 2b) What genres and top artists have been most influenced by Oceanus Folk?

### {style="color:DarkOrange"} 5.2.1 What genres have been most influenced by Oceanus Folk?
...
# {style="color:DarkOrange"} 6 VAST 2025 MC1 Question 3

Use your visualizations to develop a profile of what it means to be a rising star in the music industry.

## {style="color:DarkOrange"} 6.1 Analysing the careers of all Artists
...
## {style="color:DarkOrange"} 6.2 Question 3a) Visualize the careers of three artists. Compare and contrast their rise in popularity and influence?
...
### {style="color:DarkOrange"} 6.2.1 Visualizing the career of Sailor Shift
...
### {style="color:DarkOrange"} 6.2.2 Visualizing the career of Jay Walters
...
### {style="color:DarkOrange"} 6.2.3 Visualizing the career of Min Fu
...
### {style="color:DarkOrange"} 6.2.4 Compare and contrast the three artists' rise in popularity and influence
...
## {style="color:DarkOrange"} 6.3 Question 3b) Using this characterization, give three predictions of who the next Oceanus Folk stars with be over the next five years.
...
### {style="color:DarkOrange"} 6.3.1 Analysing the careers of all Oceanus Folk Artists
...
### {style="color:DarkOrange"} 6.3.2 Visualizing the career of Sailor Shift
...
### {style="color:DarkOrange"} 6.3.3 Visualizing the career of Chao Wu
...
### {style="color:DarkOrange"} 6.3.4 Visualizing the career of Xia Jia
...
### {style="color:DarkOrange"} 6.3.5 Visualizing the career of Donna Caldwell
...
### {style="color:DarkOrange"} 6.3.6 Visualizing the career of Xiulan Ye
...
### {style="color:DarkOrange"} 6.3.7 Compare and contrast the five artists' rise in popularity and influence
...
### {style="color:DarkOrange"} 6.3.8 Analysing the relationships between these five artists
...
### {style="color:DarkOrange"} 6.3.8 Predicting who the next three Oceanus Folk stars with be over the next five years
